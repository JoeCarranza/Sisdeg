<?php
  ...
  $fecha = $_POST['FechaRecomendacion'];
  $nombrePersona = $_POST['NomRecomendacion'];
  $primerApellido = $_POST['Apellido1Recomendacion'];
  $segundoApellido = $_POST['Apellido2Recomendacion'];
  $cedula = $_POST['IdClienteRecomendacion'];
  $telefono = $_POST['TelClienteRecomendacion'];
  $correoElectronico = $_POST['EmailClienteRecomendacion'];
  $destinatario = $_POST['DireccionRecomendacion'];
  $motivo = $_POST['DescripcionRecomendacion'];
  $estado = "En proceso";
  $codigo = alfanumerico();
  $tipo = "Recomendación no anonima";
 ...
 // echo "$sql";  //aqui conecta con la tabla solicitud
  ...
  $sql2 = "INSERT INTO recomendacionnoanonima (Fecha, Nombre,PrimerApellido,SegundoApellido,Cedula,Telefono,CorreoElectronico,Destinatario,Motivo,Estado,ArchivoAdjunto,CodAlfanumerico, Tipo, SitioCreacion) 

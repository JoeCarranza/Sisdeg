<?php
  ...
  $fecha = $_POST['FechaRecomendacionAnonima'];
  $destinatario = $_POST['DestinatarioRecomendacionAnonima'];
  $descripcion = $_POST['DescripcionRecomendacionAnonima'];
  $estado = "En proceso";
  $codigo = alfanumerico();
  $tipo = "Recomendacion anonima";
...
//
  $sql2 = "INSERT INTO recomendacionanonima (Fecha, Destinatario, Descripcion, Estado, CodAlfanumerico, ArchivoAdjunto, Tipo, SitioCreacion) 

<?php
  ...
  $fecha = $_POST['FechaDenuncia'];
  $nombrePersona = $_POST['NomDenuncia'];
  $primerApellido = $_POST['Apellido1Denuncia'];
  $segundoApellido = $_POST['Apellido2Denuncia'];
  $cedula = $_POST['IdClienteDenuncia'];
  $telefono = $_POST['TelClienteDenuncia'];
  $correoElectronico = $_POST['EmailClienteDenuncia'];
  $destinatario = $_POST['DireccionFisicaDenuncia'];
  $motivo = $_POST['DescripcionDenuncia'];
  $estado = "En proceso";
  $codigo = alfanumerico();
  $tipo = "Denuncia";
     ...
     for($i=0;$i<$totalfiles;$i++){
         ...
         && $tipoArchivo != 'image/png' && $tipoArchivo != 'image/gif' && $tipoArchivo != 'application/pdf'){
            ...
            echo "Error";
             ...
             // Si cumple con las restricciones, sube cada uno de los archivos en el directorio /archivos
 ...
 // FIN DE CODIGO NUEVO PARA MULTIPLES ARCHIVOS
  ...
  $sql2 = "INSERT INTO denuncia (CodAlfanumerico,Tipo, SitioCreacion, Fecha, Nombre, PrimerApellido, SegundoApellido, Cedula, Telefono, CorreoElectronico, DireccionFisica, Descripcion, Estado, ArchivoAdjunto) 
  VALUES ('$codigo', '$tipo','$sitioCreacion','$fecha','$nombrePersona','$primerApellido','$segundoApellido','$cedula','$telefono','$correoElectronico','$destinatario','$motivo','$estado','$adjunto')";
